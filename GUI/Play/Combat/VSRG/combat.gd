...
@onready var music_player: AudioStreamPlayer = $SpellSFX
@onready var lanes = $LanesContainer
@onready var notes = $Notes
@onready var hitline = $Hitline
@onready var audio_bus = AudioServer.get_bus_index("SpellSFX")
@onready var pitch_shift = AudioServer.get_bus_effect(audio_bus, 0) as AudioEffectPitchShift

const BEAT_NOTE = preload("res://GUI/Play/Combat/VSRG/Notes/Beatnote/Beatnote.tscn")
const HOLD_NOTE = preload("res://GUI/Play/Combat/VSRG/Notes/Holdnote/Holdnote.tscn")
